...
const DOMAIN_NAME = 'void.vin' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    author: {
      name: 'K', // 必需
      link: 'https://github.com/hiderx', // 可选的
    },
    ...
    blogger: {
      ...
      name: 'K',
      slogan: '一以贯之的努力，不得懈怠的人生',
    },

    // 社交图标 (显示于博主信息栏和页脚栏。内置图标：https://doc.xugaoyi.com/pages/a20ce8/#social)
    social: {
      //iconfontCssFile: 'at.alicdn.com/t/c/font_4353680_440mlafgvit.css', // 可选，阿里图标库在线css文件地址，对于主题没有的图标可自己添加。阿里图片库：https://www.iconfont.cn/
      icons: [
        // {
        ...
        // },
        {
          ...
          title: 'GitHub',
          link: 'https://github.com/hiderx',
        },
        {
          iconClass: 'icon-yuque',
          title: '语雀',
          link: 'https://www.yuque.com/hatsune_miku',
        },
        {
          iconClass:'icon-zhihu',
          title:'知乎',
          link:'https://www.zhihu.com/people/skalyx'
        },
      ],
    },
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: '7a446945499920090a95',
          clientSecret: '9f8ccaf0f32e7d389367fbd998f469db0cbb76bf',
          repo: 'blog-gitalk-comment', // GitHub 仓库
          owner: 'hiderx', // GitHub仓库所有者
          admin: ['hiderx'], // 对仓库有写权限的人
